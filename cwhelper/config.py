...
_FEATURE_REGISTRY = {
    ...
    "watcher":         {"label": "Queue watcher",              "cli_cmd": "watch",          "menu_keys": ["3"],      "deps": ["jira"],           "default": True},
    "rack_report":     {"label": "Rack report",               "cli_cmd": "rack-report",    "menu_keys": ["r"],      "deps": ["jira"],           "default": True},
    ...
    "bookmarks":       {"label": "Bookmarks",                  "cli_cmd": None,             "menu_keys": ["5"],      "deps": ["jira"],           "default": True},
    "bulk_start":      {"label": "Bulk start tickets",         "cli_cmd": None,             "menu_keys": ["p", "P"], "deps": ["jira"],           "default": True},
