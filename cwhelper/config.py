...
_FEATURE_REGISTRY = {
    ...
    "my_tickets":      {"label": "My tickets",                 "cli_cmd": None,             "menu_keys": ["2"],      "deps": ["jira"],           "default": True},
    "node_history":    {"label": "Node history",               "cli_cmd": "history",        "menu_keys": [],         "deps": ["jira"],           "default": True},
    ...
    "watcher":         {"label": "Queue watcher",              "cli_cmd": "watch",          "menu_keys": [],         "deps": ["jira"],           "default": True},
    "rack_report":     {"label": "Rack report",               "cli_cmd": "rack-report",    "menu_keys": [],         "deps": ["jira"],           "default": True},
    "ibtrace":         {"label": "IB trace",                   "cli_cmd": "ibtrace",        "menu_keys": [],         "deps": ["ib_topology"],    "default": False},
    "rack_map":        {"label": "Rack map",                   "cli_cmd": None,             "menu_keys": ["3"],      "deps": ["netbox"],         "default": False},
    "bookmarks":       {"label": "Bookmarks",                  "cli_cmd": None,             "menu_keys": ["4"],      "deps": ["jira"],           "default": False},
    "scripts":         {"label": "Batch scripts",              "cli_cmd": None,             "menu_keys": ["p"],      "deps": ["jira"],           "default": True},
    "activity":        {"label": "Activity log",               "cli_cmd": None,             "menu_keys": ["l"],      "deps": ["jira"],           "default": True},
    "walkthrough":     {"label": "Walkthrough",                "cli_cmd": None,             "menu_keys": ["w"],      "deps": ["jira", "netbox"], "default": False},
    "weekend_assign":  {"label": "Weekend auto-assign",        "cli_cmd": "weekend-assign", "menu_keys": [],         "deps": ["jira"],           "default": True},
